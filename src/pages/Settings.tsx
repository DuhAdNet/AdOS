      ...
      <div className="flex-1 overflow-y-auto p-8">
        {activeTab === 'api-keys' && (
          <div className="max-w-2xl">
            ...
            <p className="text-sm text-muted mb-6">
              Chaves criptografadas via Windows Credential Manager. Nunca armazenadas em texto plano.
            </p>
        ...
        {activeTab === 'about' && (
          <div className="max-w-2xl">
            ...
            <p className="text-sm text-muted mb-6">
              Plataforma de agente IA desktop da AdNet Monetize.
            </p>
            ...
            <div className="bg-surface-1 border border-default rounded-2xl p-6 shadow-card">
              ...
              <div className="space-y-2 text-sm text-secondary">
                <p>Chat com múltiplos modelos de IA</p>
                <p>Browser automation integrado</p>
                <p>Automações e memória persistente</p>
              </div>
            </div>
          </div>
        )}
